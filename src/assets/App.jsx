...
const pages = ["PRINT", "DIGITAL"];

const sections = {
  PRINT: {
    title: "Print Work",
    items: [
      { name: "Poster Series — Archival Research", date: "2023" },
      { name: "Binghamton University Art Museum — Exhibition Catalogue", date: "2022" },
      { name: "Zine: Recontextualize", date: "2022" },
      { name: "Editorial Layouts — Senior Thesis", date: "2023" },
    ]
  },
  DIGITAL: {
    title: "Digital Work",
    items: [
      { name: "Portfolio Website (this one!)", date: "2024" },
      { name: "Social Media Campaign — BU Art Museum", date: "2023" },
      { name: "Motion Graphics Reel — After Effects", date: "2023" },
      { name: "UI/UX Concepts — Adobe XD", date: "2022" },
    ]
  },
};
      ...
      {selected !== null && (
        <div className="win98-window fade-in" style={{ marginTop: "16px" }}>
          ...
          <div style={{ padding: "12px 16px", background: dark ? "#12121e" : "#fff", fontFamily: "Share Tech Mono", fontSize: "12px", lineHeight: 1.8, color: text }}>
            <div><strong>File:</strong> {data.items[selected].name}</div>
